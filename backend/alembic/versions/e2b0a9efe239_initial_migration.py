...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_model",
            sa.Enum("DAILY_WAGE", "CONTRACT_FIXED", name="paymentmodel"),
            nullable=False,
        ),
        sa.Column(
            "default_daily_rate", sa.Numeric(precision=10, scale=2), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "unit_cost_at_time", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "DRAFT", "SENT", "APPROVED", "REJECTED", "ARCHIVED", name="quotestatus"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "skill_level",
            sa.Enum("HELPER", "SKILLED", "FOREMAN", name="skilllevel"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "total_project_value", sa.Numeric(precision=12, scale=2), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "total_agreed_value", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        ...
        sa.Column(
            "pending_approvals", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "ACTIVE", "COMPLETED", "DELAYED", name="sprintstatus"),
            nullable=False,
        ),
        sa.Column("start_date", sa.Date(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED_BY_MANAGER", "PAID", name="attendancestatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("REQUESTED", "APPROVED", "REJECTED", "PAID", name="vostatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum("INFLOW", "OUTFLOW", name="transactioncategory"),
            nullable=False,
        ),
        sa.Column(
            "source",
            sa.Enum(
                "CLIENT", "VENDOR", "LABOR", "PETTY_CASH", name="transactionsource"
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "CLEARED", "REJECTED", name="transactionstatus"),
            nullable=False,
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
