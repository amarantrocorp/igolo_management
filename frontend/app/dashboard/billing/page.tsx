...
const FEATURE_LIST: {
...
}[] = [
  {
    key: "max_users",
    label: "Team Members",
    format: (v) => (v === -1 ? "Unlimited" : `Up to ${v}`),
  },
  {
    key: "max_projects",
  ...
  const handleUpgrade = useCallback(
    async (plan: string) => {
      ...
      try {
        ...
        toast({
          title: "Error",
          description: "Could not initiate upgrade.",
          variant: "destructive",
        });
        setUpgrading(null);
      }
                ...
                {billing.status === "TRIAL" &&
                  billing.days_remaining != null && (
                    <div className="rounded-lg border p-4">
                      ...
                      <p
                        className={`text-2xl font-bold ${billing.days_remaining <= 3 ? "text-red-500" : "text-amber-500"}`}
                      >
              ...
              return (
                ...
                >
                  ...
                  <CardHeader>
                    ...
                    <CardTitle>
                      {PLAN_DISPLAY[plan.name]?.label ?? plan.name}
                    </CardTitle>
                    <CardDescription>
                  ...
                  <CardFooter>
                    {plan.name === "ENTERPRISE" ? (
                      <Button variant="outline" className="w-full" asChild>
                        <a href="mailto:sales@igolohomes.com">Contact Sales</a>
                      </Button>
                    ) : isCurrent ? (
